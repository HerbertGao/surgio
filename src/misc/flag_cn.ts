...
export const FLAGS = {
  ...
  '🇦🇷': ['ARGENTINA', '阿根廷'],
  '🇦🇹': ['AUSTRIA', '奥地利', '维也纳'],
  '🇦🇺': ['AUSTRALIA', '澳大利亚', '澳洲', '墨尔本', '悉尼', 'SYDNEY', 'AUS'],
  '🇧🇪': ['BELGIUM', '比利时'],
  '🇧🇬': ['BULGARIA', '保加利亚'],
  '🇵🇰': ['PAKISTAN', '巴基斯坦'],
  '🇧🇷': ['BRAZIL', '巴西', '圣保罗'],
  ...
  '🇩🇰': ['DENMARK', '丹麦', 'DNK'],
  '🇵🇱': ['POL', '波兰', 'Poland'],
  '🇪🇸': ['ESP', '西班牙', 'España', 'Spain'],
  '🇪🇺': ['欧盟', '欧罗巴'],
  '🇫🇮': ['FINLAND', '芬兰', '赫尔辛基'],
  '🇫🇷': ['FR', 'FRANCE', '法国', '法國', '巴黎', 'FRA'],
  '🇬🇧': ['UK', 'ENGLAND', 'UNITED KINGDOM', '英', '伦敦', 'GBR'],
  '🇺🇦': ['UKRAINE', '乌克兰', '基辅'],
  '🇭🇺': ['HUNGARY', '匈牙利'],
  '🇭🇰': ['HK', '港', 'HONGKONG', 'HONG KONG', 'HGC', 'WTT', 'CMI', 'HKG'],
  '🇮🇳': ['INDIA', '印度', '孟买', 'MUMBAI', 'IND'],
  ...
  '🇯🇵': ['JP', 'JAPAN', '日', '东京', '大阪', '埼玉', 'NTT', 'KDDI', 'JPN'],
  '🇳🇴': ['NORWAY', '挪威'],
  '🇳🇬': ['尼日利亚', '尼日利亞', 'NGA', 'NIGERIA'],
  '🇨🇳': [
    ...TAIWAN,
    'CHINA',
    '回国',
